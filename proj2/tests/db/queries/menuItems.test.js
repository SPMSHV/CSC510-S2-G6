...
const menuItemQueries = __importStar(require("../../../src/db/queries/menuItems"));
...
describe('Menu Item Database Queries', () => {
    ...
    describe('createMenuItem', () => {
        it('creates a new menu item', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(`INSERT INTO menu_items (restaurant_id, name, description, price, category, available)
     VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`, ['rest-1', 'Pizza', 'Delicious pizza', 15.99, 'Main', true]);
...
//# sourceMappingURL=menuItems.test.js.map