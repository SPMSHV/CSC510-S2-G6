...
describe('Order Tracking Service', () => {
    ...
    describe('getOrderProgress', () => {
        it('returns correct progress for CREATED status', () => {
            const result = (0, orderTracking_1.getOrderProgress)('CREATED');
        ...
        it('returns correct progress for PREPARING status', () => {
            const result = (0, orderTracking_1.getOrderProgress)('PREPARING');
        ...
        it('returns correct progress for READY status', () => {
            const result = (0, orderTracking_1.getOrderProgress)('READY');
        ...
        it('returns correct progress for ASSIGNED status', () => {
            const result = (0, orderTracking_1.getOrderProgress)('ASSIGNED');
        ...
        it('returns correct progress for EN_ROUTE status', () => {
            const result = (0, orderTracking_1.getOrderProgress)('EN_ROUTE');
        ...
        it('returns correct progress for DELIVERED status', () => {
            const result = (0, orderTracking_1.getOrderProgress)('DELIVERED');
        ...
        it('returns correct progress for CANCELLED status', () => {
            const result = (0, orderTracking_1.getOrderProgress)('CANCELLED');
            expect(result.progress).toBe(0);
    ...
    describe('getOrderTrackingInfo', () => {
        it('returns null when order not found', async () => {
            ...
            const result = await (0, orderTracking_1.getOrderTrackingInfo)('nonexistent');
        ...
        it('returns tracking info for order without robot', async () => {
            ...
            const result = await (0, orderTracking_1.getOrderTrackingInfo)('order-1');
